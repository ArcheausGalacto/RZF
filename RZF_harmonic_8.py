...
class App:
    def __init__(self, master):
        ...
        self.scale_beta_min = tk.Scale(self.frame_sliders, from_=0.75, to=0.85, resolution=0.001, orient=tk.HORIZONTAL, command=self.update_plot)
        ...
        self.scale_beta_max = tk.Scale(self.frame_sliders, from_=10.0, to=30.0, resolution=0.1, orient=tk.HORIZONTAL, command=self.update_plot)
        ...
        self.scale_factor = tk.Scale(self.frame_sliders, from_=0.001, to=0.1, resolution=0.001, orient=tk.HORIZONTAL, command=self.update_plot)
